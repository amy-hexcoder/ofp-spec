...
OFP is a small specification, and governance is deliberately lightweight until there is more than
...
- **Versioning** is `MAJOR.MINOR`, carried in the `ofp` field of every manifest. Minor versions
